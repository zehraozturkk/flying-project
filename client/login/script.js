...
const elements = {
    ...
    sampleCredentials: document.getElementById('sampleCredentials'),
    sampleEmail: document.getElementById('sampleEmail'),
    samplePassword: document.getElementById('samplePassword'),
...
const ui = {
    showLoginForm(type) {
        ...
        // Update title and sample credentials
        if (type === 'user') {
            elements.loginTitle.textContent = '👤 Kullanıcı Girişi';
            elements.sampleEmail.textContent = 'test@example.com';
            elements.samplePassword.textContent = '123456';
        } else {
            elements.loginTitle.textContent = '⚙️ Admin Girişi';
            elements.sampleEmail.textContent = 'admin@flyticket.com';
            elements.samplePassword.textContent = 'admin123';
        }
    ...
    fillSampleCredentials() {
        if (currentLoginType === 'user') {
            ...
            elements.passwordInput.value = '123456';
        } else {
            elements.emailInput.value = 'admin@flyticket.com';
